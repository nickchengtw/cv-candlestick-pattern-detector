...
class ObjectDetector:
    ...
    def detect(self, image, winDim, minSize=(200, 200), winStep=4, pyramidScale=1.5, minProb=0.7):
        # initialize the list of bounding boxes and associated probabilities
        boxes = []
        probs = []

        # loop over the image pyramid
        for layer in helpers.pyramid(image, scale=pyramidScale, minSize=minSize):
            ...
            for (x, y, window) in helpers.sliding_window(layer, winStep, winDim):
                ...
                if winH == winDim[1] and winW == winDim[0]:
                    ...
                    # and classify whether or not this window contains an object
